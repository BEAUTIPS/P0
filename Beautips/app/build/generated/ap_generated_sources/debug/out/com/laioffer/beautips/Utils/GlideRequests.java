package com.laioffer.beautips.Utils;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.laioffer.beautips.Utils.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.laioffer.beautips.Utils.GlideOptions().apply(toSet));
    }
  }
}
